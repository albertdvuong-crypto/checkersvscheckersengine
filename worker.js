...
self.onmessage = function(e) {
    ...
    if (msg.cmd === 'search') {
        ...
        // FIXED: Allocate ONE single working history array reference
        ...
        for (let depth = 1; depth <= 50; depth++) {
            ...
            for (let m of moves) {
                ...
                // FIXED: Pass the reference! Removes extreme array cloning load.
                let val = continues
        ...
        // Send final compiled stats to the frontend
        self.postMessage({
            type: 'bestmove',
            bestMove: globalBestMove,
            bestVal: globalBestVal,
